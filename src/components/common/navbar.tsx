...
export const Navbar = () => {
  ...
  const getMenuLabel = (id: string, defaultLabel: string) => {
    switch (id) {
      case "properties":
        return t.nav.realEstate;
      case "furniture":
        return t.nav.furniture;
      case "services":
        return t.nav.agency;
      case "tools":
        return t.nav.tools;
          ...
          {MEGA_MENUS.map((menu) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span>{getMenuLabel(menu.id, menu.label)}</span>
                  <ChevronDown
                      ...
                      <div className="bg-white rounded-3xl p-6 border border-slate-200/90 shadow-2xl shadow-slate-900/10 grid grid-cols-12 gap-6 overflow-hidden">
                        ...
                        <div className="col-span-7 space-y-1.5">
                          <div className="text-[11px] font-bold uppercase tracking-wider text-slate-400 px-3 mb-2">
                            {getMenuLabel(menu.id, menu.label)}
                          </div>
                          {menu.items.map((item) => {
          ...
          >
            <div className="space-y-3">
              ...
              <div className="pb-3 border-b border-slate-100 flex flex-wrap items-center justify-between gap-2">
                <span className="text-xs font-bold text-slate-700">{t.nav.switchLanguage}</span>
              ...
              {MEGA_MENUS.map((menu) => {
                ...
                const menuLabel = getMenuLabel(menu.id, menu.label);
                return (
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col gap-2.5">
                ...
                >
                  ...
                  <span>{t.nav.downloadApp} (.APK - 3.3 MB)</span>
                </a>
